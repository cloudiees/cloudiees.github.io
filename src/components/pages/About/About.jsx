...
export default function About() {
    return (
        <div className="content-body">
            ...
            <div className="box">
                <span>
                    Hello, I'm Ibrahim! I'm currently pursuing my bachelor's degree in Computer Science at the University of Illinois Chicago, with plans to continue on to a master's in the near future.
                    <br /><br />
                    I have a passion for creating and building, whether that means coding projects, designing custom keyboards, or exploring new ideas through hands-on learning. In my free time, I also enjoy gaming and diving into new technologies.
                </span>
            </div>
